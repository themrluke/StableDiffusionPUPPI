...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      input2_t input_images[N_INPUT_1_2*N_INPUT_2_2*N_INPUT_3_2];
      nnet::copy_data<float, input2_t, 0, N_INPUT_1_2*N_INPUT_2_2*N_INPUT_3_2>(in, input_images);
      input_t pos_enc_main[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1];
      nnet::copy_data<float, input_t, 256, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(in, pos_enc_main);
      input17_t pos_enc_bottleneck[N_INPUT_1_17*N_INPUT_2_17*N_INPUT_3_17];
      nnet::copy_data<float, input17_t, 1280, N_INPUT_1_17*N_INPUT_2_17*N_INPUT_3_17>(in, pos_enc_bottleneck);
