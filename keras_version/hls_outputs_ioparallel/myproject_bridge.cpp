...
void allocate_trace_storage(size_t element_size) {
    ...
    nnet::trace_outputs->insert(std::pair<std::string, void *>("out", (void *) malloc(OUT_HEIGHT_52*OUT_WIDTH_52*N_FILT_52 * element_size)));
