...
wire   [0:0] tmp_4846_fu_90_p3;
wire   [0:0] p_Result_17_fu_64_p3;
wire   [0:0] xor_ln416_fu_98_p2;
wire   [2:0] p_Result_s_350_fu_118_p4;
...
wire   [0:0] or_ln340_1411_fu_252_p2;
wire   [0:0] or_ln340_fu_246_p2;
wire   [0:0] or_ln340_1412_fu_258_p2;
...
assign Range2_all_ones_fu_128_p2 = ((p_Result_s_350_fu_118_p4 == 3'd7) ? 1'b1 : 1'b0);
...
assign ap_return = ((or_ln340_1412_fu_258_p2[0:0] === 1'b1) ? select_ln340_fu_264_p3 : select_ln388_fu_272_p3);
...
assign or_ln340_1411_fu_252_p2 = (xor_ln785_15_fu_210_p2 | and_ln786_fu_222_p2);

assign or_ln340_1412_fu_258_p2 = (or_ln340_1411_fu_252_p2 | and_ln781_fu_192_p2);
...
assign p_Result_s_350_fu_118_p4 = {{x_V[15:13]}};
...
assign tmp_4846_fu_90_p3 = p_Val2_9_fu_84_p2[32'd7];

assign tmp_4848_fu_164_p3 = x_V[32'd12];

assign tmp_fu_72_p3 = x_V[32'd3];

assign underflow_fu_240_p2 = (xor_ln786_fu_234_p2 & p_Result_s_fu_46_p3);

assign xor_ln416_fu_98_p2 = (tmp_4846_fu_90_p3 ^ 1'd1);

assign xor_ln779_fu_172_p2 = (tmp_4848_fu_164_p3 ^ 1'd1);
