...
`define AUTOTB_TVIN_input_images_V_data_0_V  "./c.myproject.autotvin_input_images_V_data_0_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_0_V  "./c.myproject.autotvin_pos_enc_main_V_data_0_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_1_V  "./c.myproject.autotvin_pos_enc_main_V_data_1_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_2_V  "./c.myproject.autotvin_pos_enc_main_V_data_2_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_3_V  "./c.myproject.autotvin_pos_enc_main_V_data_3_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_0_V  "./c.myproject.autotvin_pos_enc_bottleneck_V_data_0_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_1_V  "./c.myproject.autotvin_pos_enc_bottleneck_V_data_1_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_2_V  "./c.myproject.autotvin_pos_enc_bottleneck_V_data_2_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_3_V  "./c.myproject.autotvin_pos_enc_bottleneck_V_data_3_V.dat"
`define AUTOTB_TVIN_layer48_out_V_data_0_V  "./c.myproject.autotvin_layer48_out_V_data_0_V.dat"
`define AUTOTB_TVIN_input_images_V_data_0_V_out_wrapc  "./rtl.myproject.autotvin_input_images_V_data_0_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_0_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_main_V_data_0_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_1_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_main_V_data_1_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_2_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_main_V_data_2_V.dat"
`define AUTOTB_TVIN_pos_enc_main_V_data_3_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_main_V_data_3_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_0_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_bottleneck_V_data_0_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_1_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_bottleneck_V_data_1_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_2_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_bottleneck_V_data_2_V.dat"
`define AUTOTB_TVIN_pos_enc_bottleneck_V_data_3_V_out_wrapc  "./rtl.myproject.autotvin_pos_enc_bottleneck_V_data_3_V.dat"
`define AUTOTB_TVIN_layer48_out_V_data_0_V_out_wrapc  "./rtl.myproject.autotvin_layer48_out_V_data_0_V.dat"
`define AUTOTB_TVOUT_layer48_out_V_data_0_V  "./c.myproject.autotvout_layer48_out_V_data_0_V.dat"
`define AUTOTB_TVOUT_layer48_out_V_data_0_V_out_wrapc  "./impl_rtl.myproject.autotvout_layer48_out_V_data_0_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 31245;
parameter LENGTH_input_images_V_data_0_V = 4096;
parameter LENGTH_pos_enc_main_V_data_0_V = 4096;
parameter LENGTH_pos_enc_main_V_data_1_V = 4096;
parameter LENGTH_pos_enc_main_V_data_2_V = 4096;
parameter LENGTH_pos_enc_main_V_data_3_V = 4096;
parameter LENGTH_pos_enc_bottleneck_V_data_0_V = 1024;
parameter LENGTH_pos_enc_bottleneck_V_data_1_V = 1024;
parameter LENGTH_pos_enc_bottleneck_V_data_2_V = 1024;
parameter LENGTH_pos_enc_bottleneck_V_data_3_V = 1024;
parameter LENGTH_layer48_out_V_data_0_V = 4096;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.myproject.autotvout_layer48_out_V_data_0_V.dat", "r");
    fp2 = $fopen("./impl_rtl.myproject.autotvout_layer48_out_V_data_0_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.myproject.autotvout_layer48_out_V_data_0_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.myproject.autotvout_layer48_out_V_data_0_V.dat\"!");
    else begin
        $display("Comparing rtl.myproject.autotvout_layer48_out_V_data_0_V.dat with impl_rtl.myproject.autotvout_layer48_out_V_data_0_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_IN_input_images_V_data_0_V "./stream_size_in_input_images_V_data_0_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_main_V_data_0_V "./stream_size_in_pos_enc_main_V_data_0_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_main_V_data_1_V "./stream_size_in_pos_enc_main_V_data_1_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_main_V_data_2_V "./stream_size_in_pos_enc_main_V_data_2_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_main_V_data_3_V "./stream_size_in_pos_enc_main_V_data_3_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_bottleneck_V_data_0_V "./stream_size_in_pos_enc_bottleneck_V_data_0_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_bottleneck_V_data_1_V "./stream_size_in_pos_enc_bottleneck_V_data_1_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_bottleneck_V_data_2_V "./stream_size_in_pos_enc_bottleneck_V_data_2_V.dat"
    ...
    `define STREAM_SIZE_IN_pos_enc_bottleneck_V_data_3_V "./stream_size_in_pos_enc_bottleneck_V_data_3_V.dat"
