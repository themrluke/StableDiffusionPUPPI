...
set ID 25
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_fixed_8_2_0_0_0_1u_config6_s_line_buffer_Array_V_0_0
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_elem_data_V_read { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_1_V_read { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_2_V_read { I 8 vector } } \
} "
}
