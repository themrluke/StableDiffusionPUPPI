...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myproject.autotvin_input_images_V_data_0_V.dat"
         "c.myproject.autotvin_pos_enc_main_V_data_0_V.dat"
         "c.myproject.autotvin_pos_enc_main_V_data_1_V.dat"
         "c.myproject.autotvin_pos_enc_main_V_data_2_V.dat"
         "c.myproject.autotvin_pos_enc_main_V_data_3_V.dat"
         "c.myproject.autotvin_pos_enc_bottleneck_V_data_0_V.dat"
         "c.myproject.autotvin_pos_enc_bottleneck_V_data_1_V.dat"
         "c.myproject.autotvin_pos_enc_bottleneck_V_data_2_V.dat"
         "c.myproject.autotvin_pos_enc_bottleneck_V_data_3_V.dat"
         "c.myproject.autotvin_layer48_out_V_data_0_V.dat"
         "c.myproject.autotvout_layer48_out_V_data_0_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject.autotvout_layer48_out_V_data_0_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
