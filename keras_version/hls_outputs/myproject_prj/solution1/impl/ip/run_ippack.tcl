...
set solution_dir "/storage/sa21722/stablediffusion/keras_version/hls_outputs/myproject_prj/solution1"
...
set Interfaces {
    input_images_V_data_0_V {
        type "axi4stream"
        mode "slave"
        port_prefix "input_images_V_data_0_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_main_V_data_0_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_main_V_data_0_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_main_V_data_1_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_main_V_data_1_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_main_V_data_2_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_main_V_data_2_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_main_V_data_3_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_main_V_data_3_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_bottleneck_V_data_0_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_bottleneck_V_data_0_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_bottleneck_V_data_1_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_bottleneck_V_data_1_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_bottleneck_V_data_2_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_bottleneck_V_data_2_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    pos_enc_bottleneck_V_data_3_V {
        type "axi4stream"
        mode "slave"
        port_prefix "pos_enc_bottleneck_V_data_3_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    layer48_out_V_data_0_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer48_out_V_data_0_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    ap_clk {
        ...
        buses "input_images_V_data_0_V pos_enc_main_V_data_0_V pos_enc_main_V_data_1_V pos_enc_main_V_data_2_V pos_enc_main_V_data_3_V pos_enc_bottleneck_V_data_0_V pos_enc_bottleneck_V_data_1_V pos_enc_bottleneck_V_data_2_V pos_enc_bottleneck_V_data_3_V layer48_out_V_data_0_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 2.778 machine 64 combinational 0 latency 5551 II x}
