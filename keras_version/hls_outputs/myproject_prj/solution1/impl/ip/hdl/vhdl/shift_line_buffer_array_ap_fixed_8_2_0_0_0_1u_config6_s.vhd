...
entity shift_line_buffer_array_ap_fixed_8_2_0_0_0_1u_config6_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of shift_line_buffer_array_ap_fixed_8_2_0_0_0_1u_config6_s is 
    ...
    signal line_buffer_Array_V_1631_0_ce0 : STD_LOGIC;
    signal line_buffer_Array_V_1631_0_we0 : STD_LOGIC;
    signal line_buffer_Array_V_1631_0_q0 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    line_buffer_Array_V_0_0_U : component shift_line_buffer_array_ap_fixed_8_2_0_0_0_1u_config6_s_line_buffer_Array_V_0_0
    generic map (
        DataWidth => 8,
        AddressRange => 66,
        AddressWidth => 7)
    ...
    line_buffer_Array_V_1631_0_U : component shift_line_buffer_array_ap_fixed_8_2_0_0_0_1u_config6_s_line_buffer_Array_V_0_0
    generic map (
        DataWidth => 8,
        AddressRange => 66,
        AddressWidth => 7)
    port map (
        ...
        reset => ap_rst,
        address0 => ap_const_lv7_41,
        ce0 => line_buffer_Array_V_1631_0_ce0,
        we0 => line_buffer_Array_V_1631_0_we0,
        d0 => line_buffer_Array_V_0_0_q0,
        q0 => line_buffer_Array_V_1631_0_q0);
    ...
    ap_return_4 <= line_buffer_Array_V_1631_0_q0;
    ...
    line_buffer_Array_V_1631_0_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            line_buffer_Array_V_1631_0_ce0 <= ap_const_logic_1;
        else 
    ...
    line_buffer_Array_V_1631_0_we0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            line_buffer_Array_V_1631_0_we0 <= ap_const_logic_1;
        else 
