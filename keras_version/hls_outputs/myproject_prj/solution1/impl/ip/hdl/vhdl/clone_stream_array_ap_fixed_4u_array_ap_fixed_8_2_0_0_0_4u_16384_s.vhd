...
entity clone_stream_array_ap_fixed_4u_array_ap_fixed_8_2_0_0_0_4u_16384_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clone_stream_array_ap_fixed_4u_array_ap_fixed_8_2_0_0_0_4u_16384_s is 
    ...
    signal i_0_reg_208 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal i_fu_225_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    i_fu_225_p2 <= std_logic_vector(unsigned(i_0_reg_208) + unsigned(ap_const_lv13_1));
    icmp_ln22_fu_219_p2 <= "1" when (i_0_reg_208 = ap_const_lv13_1000) else "0";
