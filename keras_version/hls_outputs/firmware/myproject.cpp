...
void myproject(
    ...
    #pragma HLS STREAM variable=layer52_cpy1 depth=768
    hls::stream<input_t> layer52_cpy2("layer52_cpy2");
    #pragma HLS STREAM variable=layer52_cpy2 depth=768
    nnet::clone_stream<input_t, input_t, 3072>(pos_enc_main, layer52_cpy1, layer52_cpy2); // clone_pos_enc_main

    hls::stream<layer49_t> layer49_out("layer49_out");
    #pragma HLS STREAM variable=layer49_out depth=768
    ...
    #pragma HLS STREAM variable=layer5_out depth=768
    ...
    #pragma HLS STREAM variable=layer53_out depth=924
    nnet::zeropad2d_cl<layer5_t, layer53_t, config53>(layer5_out, layer53_out); // zp2d_convd1_1

    hls::stream<layer6_t> layer6_out("layer6_out");
    #pragma HLS STREAM variable=layer6_out depth=768
    ...
    #pragma HLS STREAM variable=layer9_out depth=768
    ...
    #pragma HLS STREAM variable=layer54_out depth=924
    nnet::zeropad2d_cl<layer9_t, layer54_t, config54>(layer9_out, layer54_out); // zp2d_convd1_2

    hls::stream<layer10_t> layer10_out("layer10_out");
    #pragma HLS STREAM variable=layer10_out depth=768
    ...
    #pragma HLS STREAM variable=layer13_out depth=768
    ...
    #pragma HLS STREAM variable=layer55_out depth=845
    nnet::zeropad2d_cl<layer13_t, layer55_t, config55>(layer13_out, layer55_out); // zp2d_pool3

    hls::stream<layer14_t> layer14_out("layer14_out");
    #pragma HLS STREAM variable=layer14_out depth=192
    ...
    #pragma HLS STREAM variable=layer18_out depth=192
    ...
    #pragma HLS STREAM variable=layer21_out depth=192
    ...
    #pragma HLS STREAM variable=layer56_out depth=272
    ...
    #pragma HLS STREAM variable=layer22_out depth=192
    ...
    #pragma HLS STREAM variable=layer25_out depth=192
    ...
    #pragma HLS STREAM variable=layer57_out depth=272
    ...
    #pragma HLS STREAM variable=layer29_out depth=192
    ...
    #pragma HLS STREAM variable=layer30_out depth=768
    ...
    #pragma HLS STREAM variable=layer58_out depth=924
    ...
    #pragma HLS STREAM variable=layer31_out depth=768
    ...
    #pragma HLS STREAM variable=layer34_out depth=768
    ...
    #pragma HLS STREAM variable=layer51_out depth=768
    ...
    #pragma HLS STREAM variable=layer37_out depth=768
    ...
    #pragma HLS STREAM variable=layer59_out depth=924
    ...
    #pragma HLS STREAM variable=layer38_out depth=768
    ...
    #pragma HLS STREAM variable=layer41_out depth=768
    ...
    #pragma HLS STREAM variable=layer60_out depth=924
    ...
    #pragma HLS STREAM variable=layer42_out depth=768
    ...
    #pragma HLS STREAM variable=layer45_out depth=768
    ...
    #pragma HLS STREAM variable=layer61_out depth=768
